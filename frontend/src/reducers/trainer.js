const initialState = {
    ...
    TraineesTableLoading:false,
    TraineesTableData:[],
    DataActiveTraineesDetails : {
        traineeDetailsId : null,
        traineeScores : []
    },
}
...
export default (state = initialState, action )=>{
    switch(action.type){
        ...
        case 'CHANGE_TRAINEE_DETAILS_MODAL_STATE':
            return {
                ...state,
                TraineeDetailsmodalOpened : action.payload1,
                DataActiveTraineesDetails :{
                    ...state.DataActiveTraineseDetails,
                    traineeDetailsId : action.payload2
                }
            }
        case 'CHANGE_TRAINEE_SEARCH_TEXT':
            return {
                ...state,
                TraineesearchText : action.payload
            }
        case 'CHANGE_TRAINEE_TABLE_LOADING_STATUS':
            return {
                ...state,
                TraineesTableLoading : action.payload1,
                TraineesTableData :action.payload2
            }
        case 'CHANGE_CURRENT_ACTIVE_TRAINEE_SCORES':
            return{
                ...state,
                DataActiveTraineesDetails:{
                    ...state.DataActiveTraineesDetails,
                    traineeScores:action.payload
                }
            }
        default:
            return state;
