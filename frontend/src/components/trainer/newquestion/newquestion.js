...
class NewQuestion extends Component {
    ...
    Customalert = ()=>{
        Modal.confirm({
            title: 'تأكيد',
            content: 'لا يمكن تعيين الخيار الفارغ كإجابة',
            okText: 'أفهم',
            cancelText: null,
        });
    }
    ...
    handleSubmit = e => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            if (!err) {
                ...
                if(f){
                    if(!ans){
                        Alert('warning','Warning!','يجب أن تكون هناك إجابة واحدة صحيحة على الأقل');
                    }
                    else{
                        this.setState({
                            adding:true
                    ...
                    Alert('warning','Warning!','يرجى ملء جميع الخيارات');
                }
            }
        });
    };
                ...
                <div className="register-trainer-form-body">
                    <Form  onSubmit={this.handleSubmit}>
                        <div>
                            <Row >
                                <Col span={18}>
                                    <Form.Item label="الموضوع" hasFeedback>
                                        {getFieldDecorator('subject', {
                                            rules: [{ required: true, message: 'الرجاء تحديد أي موضوع!' }],
                                        })(
                                            <Select
                                                showSearch
                                                style={{ width:'100%'}}
                                                placeholder="اختر موضوعا"
                                                optionFilterProp="s"
                                            >
                                                {
                            ...
                            <Row>
                                <Col span={18}>
                                    <Form.Item label="السؤال" hasFeedback>
                                        {getFieldDecorator('questionbody', {
                                            rules: [{ required: true, message: 'الرجاء كتابة السؤال!' }],
                                        })(
                                            <TextArea rows={5} />
                                        )}
                                    </Form.Item>
                            ...
                            <Row>
                                <Col span={18}>
                                    <Form.Item label="توضيح" hasFeedback>
                                        {getFieldDecorator('explanation', {
                                            rules: [{ required: true, message: 'الرجاء كتابة شرح للإجابات!' }],
                                        })(
                                ...
                                <Col offset={2} span={4}>
                                    <Form.Item label="الوزن" hasFeedback>
                                        {getFieldDecorator('waitage', {
                                            rules: [{ required: true, message: 'الرجاء إدخال العلامات' }],
                                        })(
                                        ...
                                        return(
                                            <Row key={i} className="">
                                                ...
                                                <Col offset={2} span={6} style={{textAlign:'center'}}>
                                                    <Form.Item label={`اختيار ${i+1} صورة`}>
                            ...
                            <Row>
                                <Col span={12}>
                                    { this.state.fifthoptioAddButtonVisible ? <Button type="primary" onClick={(e)=>this.addfifthOption(e)}>إضافة اختيار خامس</Button> : null}
                                </Col>
                            </Row>
                            <Row>
