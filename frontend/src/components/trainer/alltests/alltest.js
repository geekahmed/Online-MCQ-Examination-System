      ...
      const columns = [
        {
          ...
          dataIndex: 'title',
          key: 'title',
          ...this.getColumnSearchProps('title', 'الإسم'),
        },
        {
          title: 'النوع',
          dataIndex: 'type',
          key: 'type',
          ...this.getColumnSearchProps('type', 'النوع'),
        },
        {
          title: 'المواضيع',
          dataIndex: 'subjects',
        ...
        return (
            <div className="admin-table-container">
              <div className="register-trainer-form-header">
                <Title level={4} style={{color:'#fff',textAlign:'center'}}>قائمة الاختبارات</Title>
              </div>
              <Table 
                bordered={true} 
                columns={columns} 
